...
embedingmodel=embedingmodel=GoogleGenerativeAIEmbeddings(model="models/embedding-001")
...
similarityRetriever= vectorstore.as_retriever(search_type="similarity", search_kwargs={"k": 5})
